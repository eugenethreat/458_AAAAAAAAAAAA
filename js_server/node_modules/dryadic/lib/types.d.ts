...
export declare type MiddlewareCommand = any;
/**
 ...
 */
export declare type Middleware = (command: Command, context: Context, properties: Properties, updateContext: UpdateContext) => void | Promise<void>;
 ...
 */
export declare type UpdateContext = (context: Context, updates: Context) => void;
export interface HyperScript extends HyperScriptTuple<HyperScript> {
}
declare type HyperScriptTuple<T> = [string, Properties, T[]];
