...
const OSCSched_1 = tslib_1.__importDefault(require("./OSCSched"));
/**
 ...
 */
exports.scserver = async (command, context, properties, updateContext) => {
    if (command.scserver) {
        ...
        if (cmds.schedLoop) {
            ...
            if (!oscSched) {
                ...
                oscSched = new OSCSched_1.default(sendFn);
...
exports.default = exports.scserver;
/**
...
function resolveFuncs(command, context, properties) {
    return lodash_1.default.mapValues(command, value => _callIfFn(value, context, properties));
}
